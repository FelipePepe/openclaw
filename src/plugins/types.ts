...
export type PluginHookAfterCompactionEvent = {
  ...
  sessionFile?: string;
  /** The compaction summary generated by the LLM.
   *  Memory plugins (e.g. Engram) can persist this as a checkpoint so the
   *  agent can recover context after a compaction cycle. */
  summary?: string;
};
